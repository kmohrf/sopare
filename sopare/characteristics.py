...
class Characteristic:
    ...
    def get_characteristic(self, fft, chunked_norm, meta):
        fft = numpy.abs(fft)
        df = numpy.argmax(fft)
        ...
        model_characteristic = {'df': df, 'dfm': dfm, 'fc': fc, 'peaks': peaks,
                                'token_peaks': token_peaks, 'volume': volume, 'norm': chunked_norm}
